...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'CarBatteryTraceability';
  ...
  'jhipster.mail.from' = 'CarBatteryTraceability@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'CarBatteryTraceability API';
  'jhipster.swagger.description' = 'CarBatteryTraceability API documentation';
  ...
  'eureka.instance.appname' = 'CarBatteryTraceability';
  'eureka.instance.instanceId' = 'CarBatteryTraceability:${random.value}';
  ...
  'cloud.config.name' = 'CarBatteryTraceability';
